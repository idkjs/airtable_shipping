...
and skuOrderTrackingTable = {
  ...
  skuOrdersField: tableSchemaField<skuOrderTrackingRecord, skuOrderRecord>,
...
and boxDestinationTable = {
  ...
  boxesField: tableSchemaField<boxDestinationRecord, boxRecord>,
...
and boxTable = {
  ...
  boxLinesField: tableSchemaField<boxRecord, boxLineRecord>,
...
let buildSchema: array<airtableTableDef> => schema = tdefs => {
  ...
  | Ok(gschem) => {
      skuOrderTracking: {
        ...
        skuOrdersField: getField(gschem, "skuOrders").rel.tableSchemaField,
      ...
      skuOrder: {
        ...
        trackingRecordField: getField(gschem, "trackingRecord").rel.tableSchemaField,
        skuOrderSkuField: getField(gschem, "skuOrderSku").rel.tableSchemaField,
        skuOrderBoxDestField: getField(gschem, "skuOrderBoxDest").rel.tableSchemaField,
      ...
      boxDestination: {
        ...
        boxesField: getField(gschem, "boxes").rel.tableSchemaField,
      ...
      box: {
        ...
        boxLinesField: getField(gschem, "boxLines").rel.tableSchemaField,
        boxDestField: getField(gschem, "boxDest").rel.tableSchemaField,
      ...
      boxLine: {
        ...
        boxRecordField: getField(gschem, "boxRecord").rel.tableSchemaField,
        boxLineSkuField: getField(gschem, "boxLineSku").rel.tableSchemaField,
        boxLineSkuOrderField: getField(gschem, "boxLineSkuOrder").rel.tableSchemaField,
