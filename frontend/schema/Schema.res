...
skuOrderDestinationPrefix: getField(gschem,"skuOrderDestinationPrefix").string.buildReadOnly(rawRec),
...
skuOrderDestinationPrefixField: getField(gschem,"skuOrderDestinationPrefix").string.tableSchemaField,
